...
**Speaker 2:** "The core magic happens via two APIs. We use the **Groq SDK** running the Whisper-large model for transcription. We chose Groq because its inference speed is unmatched, making voice processing feel instantaneous. For the natural language processing, we use the **Gemini 3.5 Flash Lite** model."

**(1:45 - 2:00) Why We Made These Choices**
**Speaker 2:** "We chose Gemini 3.5 Flash Lite because it's incredibly fast, lightweight, provides high rate-limit headroom, and perfectly extracts structured JSON data—like departments and urgency levels—from messy, multilingual audio. SAMADHAN bridges the digital divide with voice, and automates bureaucracy with AI."
